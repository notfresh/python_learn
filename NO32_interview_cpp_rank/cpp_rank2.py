...
if __name__ == '__main__':
    ...
    g_rank_dir_  = '/Users/zxzx/projects/interview/cpp-interview/exp'
    g_weight = {
        '实用性': 0,
        '兴趣': 0,
        '熟悉程度': 0,
    ...
    # file = 'C++m面试问题-泛型编程100问.md'
    # file_full_path = os.path.join(g_rank_dir_, file)
    # insert_rank_factor(file_full_path)
