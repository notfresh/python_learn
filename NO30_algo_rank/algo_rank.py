...
def rank_and_copy(rank_count=10, rank_by='SCORE'):
    ...
    for line in res:
        ...
        new_name = '{}_{}_{}_{}.md'.format(format_number(scnt(sz), rank_num), score, content_name, file_origin_num)
...
def format_number(len_, num):
    num_str = str(num)
    zero_cnt = len_ - len(num_str)

    if(zero_cnt > 0):
        num_str = '0'* zero_cnt + num_str
    return num_str
...
if __name__ == '__main__':
    ...
    # g_rank_dir_ = '/Users/zxzx/projects/interview/算法/algo_rank'
    g_rank_dir_ = '/Users/zxzx/projects/interview/cpp-interview/cpp_basic'

    # print(format_number(scnt(200), 1))
    # rank_and_copy(500)
    # split_algo_file_1()
    insert_rank_factor_for_all()
    # sync2source('/Users/zxzx/projects/interview/算法/Algo_rank/19_0_旋转数组_7.md')
